#!/usr/bin/env python3
"""
Simple Isaac Sim Livestream Script
Uses Isaac Sim's built-in livestreaming with minimal configuration
"""
...
try:
    ...
    logger.info("🚀 Starting Isaac Sim with livestreaming...")
    
    # Simple configuration for livestreaming
    config = {
        "headless": True,
        "width": 1920,
        "height": 1080,
